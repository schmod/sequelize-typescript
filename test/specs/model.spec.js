...
describe('model', function () {
    var sequelize;
    var MainUser = /** @class */ (function (_super) {
        __extends(MainUser, _super);
        function MainUser() {
        ...
        ], MainUser.prototype, "username", void 0);
        __decorate([
            index_1.Column,
            __metadata("design:type", String)
        ], MainUser.prototype, "secretValue", void 0);
        __decorate([
            index_1.Column,
            __metadata("design:type", String)
        ], MainUser.prototype, "data", void 0);
        __decorate([
            index_1.Column,
            __metadata("design:type", Number)
        ], MainUser.prototype, "intVal", void 0);
        __decorate([
            index_1.Column,
            __metadata("design:type", Date)
        ], MainUser.prototype, "theDate", void 0);
        __decorate([
            index_1.Column,
            __metadata("design:type", Boolean)
        ], MainUser.prototype, "aBool", void 0);
        MainUser = __decorate([
            index_1.Table
        ], MainUser);
        return MainUser;
    ...
    beforeEach(function () {
        sequelize = sequelize_2.createSequelize();
        sequelize.addModels([MainUser]);
        return MainUser.sync({ force: true });
    });
    describe('static functions when not initialized', function () {
        it('should throw an error', function () {
            ...
            chai_1.expect(function () { return Test.beforeCreate(function (test) { return test; }); }).to.throw(/^Model not initialized/);
        });
    });
    describe('constructor', function () {
        it('uses the passed dao name as tablename if freezeTableName', function () {
            var User = /** @class */ (function (_super) {
                ...
                User = __decorate([
                    index_1.Table({ freezeTableName: true, tableName: 'FrozenUser' })
                ], User);
                return User;
            }(index_1.Model));
            sequelize.addModels([User]);
            chai_1.expect(User['tableName']).to.equal('FrozenUser');
        });
        it('uses the pluralized dao name as tablename unless freezeTableName', function () {
            var User = /** @class */ (function (_super) {
                ...
                User = __decorate([
                    index_1.Table({ freezeTableName: false, tableName: 'SuperUser' })
                ], User);
                return User;
            }(index_1.Model));
            sequelize.addModels([User]);
            chai_1.expect(User['tableName']).to.equal('SuperUser');
        });
        it('uses checks to make sure dao factory isnt leaking on multiple define', function () {
            ...
            var factorySize = sequelize['modelManager'].all.length;
            (function () {
                var User = /** @class */ (function (_super) {
                    __extends(User, _super);
                    function User() {
            ...
            var factorySize2 = sequelize['modelManager'].all.length;
            chai_1.expect(factorySize).to.equal(factorySize2);
        });
        it('allows us us to predefine the ID column with our own specs', function () {
            ...
            return User.sync({ force: true }).then(function () {
                return chai_1.expect(User.create({ id: 'My own ID!' })).to.eventually.have.property('id', 'My own ID!');
            });
        });
        ...
        it('should allow me to set a default value for createdAt and updatedAt', function () {
            ...
            var User = /** @class */ (function (_super) {
                ...
                __decorate([
                    index_1.Default(moment('2012-01-01').toDate()),
                    index_1.Column,
                    __metadata("design:type", Date)
                ], User.prototype, "createdAt", void 0);
                __decorate([
                    index_1.Default(moment('2012-01-02').toDate()),
                    index_1.Column,
                    __metadata("design:type", Date)
                ], User.prototype, "updatedAt", void 0);
                User = __decorate([
                    index_1.Table({ timestamps: true })
                ], User);
                return User;
            }(index_1.Model));
            sequelize.addModels([User]);
            return User.sync({ force: true }).then(function () {
                return User.create({ aNumber: 5 }).then(function (user) {
                    clock.restore();
                    return User.bulkCreate([
                        { aNumber: 10 },
                        { aNumber: 12 }
                    ]).then(function () {
                        return User.findAll({ where: { aNumber: { $gte: 10 } } }).then(function (users) {
                            chai_1.expect(moment(user.createdAt).format('YYYY-MM-DD')).to.equal('2012-01-01');
                            chai_1.expect(moment(user.updatedAt).format('YYYY-MM-DD')).to.equal('2012-01-02');
                            users.forEach(function (u) {
                                chai_1.expect(moment(u.createdAt).format('YYYY-MM-DD')).to.equal('2012-01-01');
                                chai_1.expect(moment(u.updatedAt).format('YYYY-MM-DD')).to.equal('2012-01-02');
                            });
                        });
                    });
                });
        ...
        it('should allow me to set a function as default value', function () {
            var defaultFunction = sinon_1.stub().returns(5);
            var User = /** @class */ (function (_super) {
                __extends(User, _super);
                function User() {
                    return _super !== null && _super.apply(this, arguments) || this;
                ...
                __decorate([
                    index_1.Default(defaultFunction),
                    index_1.Column,
                    __metadata("design:type", Number)
                ], User.prototype, "aNumber", void 0);
                User = __decorate([
            ...
            return User.sync({ force: true }).then(function () {
                return User.create().then(function (user) {
                    return User.create().then(function (user2) {
                        chai_1.expect(user.aNumber).to.equal(5);
                        chai_1.expect(user2.aNumber).to.equal(5);
                        chai_1.expect(defaultFunction.callCount).to.equal(2);
                    });
                });
            });
        });
        it('should allow me to override updatedAt, createdAt, and deletedAt fields', function () {
            var User = /** @class */ (function (_super) {
                ...
                __decorate([
                    index_1.DeletedAt,
                    __metadata("design:type", Date)
                ], User.prototype, "deletedAtThisTime", void 0);
                User = __decorate([
                    index_1.Table
                ], User);
                return User;
            ...
            sequelize.addModels([User]);
            return User.sync({ force: true }).then(function () {
                return User.create({ aNumber: 4 }).then(function (user) {
                    chai_1.expect(user.updatedOn).to.exist;
                    chai_1.expect(user.dateCreated).to.exist;
                    return user.destroy().then(function () {
                        return user.reload({ paranoid: false }).then(function () {
                            chai_1.expect(user.deletedAtThisTime).to.exist;
                        });
                    });
                });
            });
        ...
        it('should allow me to disable some of the timestamp fields', function () {
            var User = /** @class */ (function (_super) {
                ...
                User = __decorate([
                    index_1.Table({ updatedAt: false, createdAt: false })
                ], User);
                return User;
            }(index_1.Model));
            sequelize.addModels([User]);
            return User.sync({ force: true }).then(function () {
                return User.create({
                    ...
                    chai_1.expect(user.createdAt).not.to.exist;
                    chai_1.expect(user['false']).not.to.exist; //  because, you know we might accidentally add a field named 'false'
                    user.name = 'heho';
                    return user.save().then(function (_user) {
                        chai_1.expect(_user.updatedAt).not.to.exist;
                        return _user.destroy().then(function () {
                            return _user.reload({ paranoid: false }).then(function () {
                                chai_1.expect(_user.deletedAtThisTime).to.exist;
                            });
                        });
                    });
                });
        ...
        it('returns proper defaultValues after save when setter is set', function () {
            ...
            var Task = /** @class */ (function (_super) {
                ...
                __decorate([
                    index_1.Column({
                        type: index_1.DataType.STRING(50),
                        allowNull: false,
                        defaultValue: '',
                        set: titleSetter
                    }),
                ...
                __decorate([
                    index_1.DeletedAt,
                    __metadata("design:type", Date)
                ], Task.prototype, "deletedAtThisTime", void 0);
                Task = __decorate([
                    index_1.Table({ updatedAt: false, createdAt: false })
                ], Task);
                return Task;
            ...
            return Task.sync({ force: true }).then(function () {
                return Task.build().save().then(function (record) {
                    chai_1.expect(record.title).to.be.a('string');
                    chai_1.expect(record.title).to.equal('');
                    chai_1.expect(titleSetter.notCalled).to.be.ok; // The setter method should not be invoked for default values
                });
            });
        });
        it('should work with both paranoid and underscored being true', function () {
            var User = /** @class */ (function (_super) {
                ...
                User = __decorate([
                    index_1.Table({ paranoid: true, underscored: true })
                ], User);
                return User;
            }(index_1.Model));
            sequelize.addModels([User]);
            return User.sync({ force: true }).then(function () {
                return User.create({ aNumber: 30 }).then(function () {
                    return User.count().then(function (c) {
                        chai_1.expect(c).to.equal(1);
                    });
                });
            });
        });
        it('allows multiple column unique keys to be defined', function () {
            var User = /** @class */ (function (_super) {
                ...
                __decorate([
                    ...
                    __metadata("design:type", String)
                ], User.prototype, "aCol", void 0);
                __decorate([
                    index_1.Column({
                        unique: 'a_and_b'
                    }),
                    __metadata("design:type", String)
                ], User.prototype, "bCol", void 0);
                User = __decorate([
                    index_1.Table
                ], User);
                return User;
            ...
            return User.sync({
                force: true, logging: _.after(2, _.once(function (sql) {
                    chai_1.expect(sql).to.match(/UNIQUE\s*([`"]?user_and_email[`"]?)?\s*\([`"]?username[`"]?, [`"]?email[`"]?\)/);
                    chai_1.expect(sql).to.match(/UNIQUE\s*([`"]?a_and_b[`"]?)?\s*\([`"]?aCol[`"]?, [`"]?bCol[`"]?\)/);
                }))
            });
        });
        it('allows unique on column with field aliases', function () {
            ...
            sequelize.addModels([User]);
            return User.sync({ force: true }).then(function () {
                return sequelize['queryInterface'].showIndex(User['tableName']).then(function (indexes) {
                    chai_1.expect(indexes).to.have.length(1);
                    var idxUnique = indexes[0];
                    chai_1.expect(idxUnique.primary).to.equal(false);
                    chai_1.expect(idxUnique.unique).to.equal(true);
                    chai_1.expect(idxUnique.fields).to.deep.equal([{ attribute: 'user_name', length: undefined, order: undefined }]);
                });
            });
        });
        it('allows us to customize the error message for unique constraint', function () {
            ...
            }).catch(sequelize_1.UniqueConstraintError, function (err) {
                chai_1.expect(err.message).to.equal('User and email must be unique');
            });
        });
        ...
        it('should allow the user to specify indexes in options', function () {
            var ModelA = /** @class */ (function (_super) {
                ...
                __decorate([
                    index_1.Column,
                    __metadata("design:type", String)
                ], ModelA.prototype, "fieldA", void 0);
                __decorate([
                    index_1.Column,
                    __metadata("design:type", Number)
                ], ModelA.prototype, "fieldB", void 0);
                __decorate([
                    index_1.Column,
                    __metadata("design:type", String)
                ], ModelA.prototype, "fieldC", void 0);
                __decorate([
                    index_1.Column,
                    __metadata("design:type", String)
                ], ModelA.prototype, "fieldD", void 0);
                ModelA = __decorate([
                    index_1.Table({
                        indexes: [{
                                name: 'a_b_uniq',
            ...
            return sequelize.sync().then(function () {
                ...
                chai_1.expect(idx1.fields).to.deep.equal([
                    { attribute: 'fieldB', length: undefined, order: undefined },
                    { attribute: 'fieldA', length: undefined, order: undefined }
                ]);
                chai_1.expect(idx2.fields).to.deep.equal([
                    { attribute: 'fieldC', length: undefined, order: undefined }
                ]);
                chai_1.expect(idx1.name).to.equal('a_b_uniq');
                chai_1.expect(idx1.unique).to.be.ok;
                chai_1.expect(idx2.name).to.equal('model_a_field_c');
                chai_1.expect(idx2.unique).not.to.be.ok;
            });
        });
    });
    describe('build', function () {
        it("doesn't create database entries", function () {
            ...
            return MainUser.findAll().then(function (users) {
                chai_1.expect(users).to.have.length(0);
            });
        });
        it('fills the objects with default values (timestamps=true)', function () {
            var Task = /** @class */ (function (_super) {
                __extends(Task, _super);
                function Task() {
                    return _super !== null && _super.apply(this, arguments) || this;
                ...
                __decorate([
                    ...
                    index_1.Column,
                    __metadata("design:type", Number)
                ], Task.prototype, "foo", void 0);
                __decorate([
                    index_1.Column,
                    __metadata("design:type", Date)
                ], Task.prototype, "bar", void 0);
                __decorate([
                    index_1.Default('asd'),
                    index_1.Column(index_1.DataType.TEXT),
                    __metadata("design:type", String)
                ], Task.prototype, "foobar", void 0);
                __decorate([
            ...
            sequelize.addModels([Task]);
            chai_1.expect(Task.build().title).to.equal('a task!');
            chai_1.expect(Task.build().foo).to.equal(2);
            chai_1.expect(Task.build().bar).to.not.be.ok;
            chai_1.expect(Task.build().foobar).to.equal('asd');
            chai_1.expect(Task.build().flag).to.be.false;
        });
        ...
        it('attaches getter and setter methods from attribute definition', function () {
            ...
            chai_1.expect(Product.build({ price: 42 }).price).to.equal('answer = 84');
            var p = Product.build({ price: 1 });
            chai_1.expect(p.price).to.equal('answer = 43');
            p.price = 0;
            chai_1.expect(p.price).to.equal('answer = 42');
        });
        it('attaches getter and setter methods from options', function () {
            ...
            sequelize.addModels([Product]);
            chai_1.expect(Product.build({ price: 20 }).priceInCents).to.equal(20 * 100);
            chai_1.expect(Product.build({ priceInCents: 30 * 100 }).price).to.equal('$' + 30);
        });
        it('attaches getter and setter methods from options only if not defined in attribute', function () {
            var Product = /** @class */ (function (_super) {
                ...
                __decorate([
                    ...
                    __metadata("design:type", Number)
                ], Product.prototype, "price1", void 0);
                __decorate([
                    index_1.Column({
                        get: function () {
                    ...
                    __metadata("design:type", Number)
                ], Product.prototype, "price2", void 0);
                Product = __decorate([
                    index_1.Table({
                        setterMethods: {
                            price1: function (v) {
            ...
            chai_1.expect(p.price1).to.equal(10);
            chai_1.expect(p.price2).to.equal(20);
        });
        describe('include', function () {
            it('should support basic includes', function () {
                var Product = /** @class */ (function (_super) {
                    ...
                    __decorate([
                        index_1.HasMany(function () { return Tag; }),
                ...
                var Tag = /** @class */ (function (_super) {
                    ...
                    __decorate([
                        index_1.ForeignKey(function () { return Product; }),
                        __metadata("design:type", Number)
                ...
                var User = /** @class */ (function (_super) {
                    ...
                    __decorate([
                        index_1.HasMany(function () { return Product; }),
                        __metadata("design:type", Array)
                ...
                chai_1.expect(product.tags).to.be.ok;
                chai_1.expect(product.tags.length).to.equal(2);
                chai_1.expect(product.tags[0]).to.be.instanceof(Tag);
                chai_1.expect(product.user).to.be.ok;
                chai_1.expect(product.user).to.be.instanceof(User);
            });
            it('should support includes with aliases', function () {
                var Product = /** @class */ (function (_super) {
                    ...
                    __decorate([
                        index_1.BelongsToMany(function () { return User; }, 'product_followers', 'productId', 'userId'),
                        __metadata("design:type", Array)
                    ], Product.prototype, "followers", void 0);
                    Product = __decorate([
                        index_1.Table
                    ], Product);
                    return Product;
                ...
                var User = /** @class */ (function (_super) {
                    ...
                    __decorate([
                        index_1.BelongsToMany(function () { return Product; }, 'product_followers', 'productId', 'userId'),
                        __metadata("design:type", Array)
                ...
                chai_1.expect(product.categories).to.be.ok;
                chai_1.expect(product.categories.length).to.equal(4);
                chai_1.expect(product.categories[0]).to.be.instanceof(Tag);
                chai_1.expect(product.followers).to.be.ok;
                chai_1.expect(product.followers.length).to.equal(2);
                chai_1.expect(product.followers[0]).to.be.instanceof(User);
            });
        });
    });
    describe('findOne', function () {
        ...
        it('should not fail if model is paranoid and where is an empty array', function () {
            var User = /** @class */ (function (_super) {
                ...
                User = __decorate([
                    index_1.Table({ paranoid: true, timestamps: true })
                ], User);
                return User;
            }(index_1.Model));
            sequelize.addModels([User]);
            return User.sync({ force: true })
                ...
                .then(function (u) {
                chai_1.expect(u.username).to.equal('A fancy name');
            });
        });
        it('should filter based on the where clause even if IFindOptions.include is []', function () {
            var User = /** @class */ (function (_super) {
                __extends(User, _super);
                function User() {
                    return _super !== null && _super.apply(this, arguments) || this;
            ...
            return User.sync({ force: true })
                ...
                .then(function (u) {
                chai_1.expect(u.username).to.equal('a2');
            })
                .then(function () {
                return User.findOne({ where: { username: 'a1' }, include: [] });
            })
                .then(function (u) {
                chai_1.expect(u.username).to.equal('a1');
            });
        });
    });
    describe('findOrInitialize', function () {
        ...
        describe('returns an instance if it already exists', function () {
            it('with a single find field', function () {
                return MainUser.create({ username: 'Username' }).then(function (user) {
                    return MainUser.findOrInitialize({
                        where: { username: user.username }
                    }).then(function (_a) {
                        var _user = _a[0], initialized = _a[1];
                        chai_1.expect(_user.id).to.equal(user.id);
                        chai_1.expect(_user.username).to.equal('Username');
                        chai_1.expect(initialized).to.be.false;
                    });
                });
            });
            it('with multiple find fields', function () {
                return MainUser.create({ username: 'Username', data: 'data' }).then(function (user) {
                    return MainUser.findOrInitialize({
                        where: {
                        ...
                        chai_1.expect(_user.id).to.equal(user.id);
                        chai_1.expect(_user.username).to.equal('Username');
                        chai_1.expect(_user.data).to.equal('data');
                        chai_1.expect(initialized).to.be.false;
                    });
                });
            });
            it('builds a new instance with default value.', function () {
                ...
                return MainUser.findOrInitialize({
                    ...
                    var user = _a[0], initialized = _a[1];
                    chai_1.expect(user.id).to.be.null;
                    chai_1.expect(user.username).to.equal('Username');
                    chai_1.expect(user.data).to.equal('ThisIsData');
                    chai_1.expect(initialized).to.be.true;
                    chai_1.expect(user.isNewRecord).to.be.true;
                });
            });
        });
    });
    describe('update', function () {
        it('throws an error if no where clause is given', function () {
            ...
            return sequelize.sync({ force: true }).then(function () {
                ...
                chai_1.expect(err.message).to.match(/^Missing where attribute in the options parameter/);
            });
        });
        // TODO@robin sqlite3 transaction issue
        // if (current.dialect.supports.transactions) {
        ...
        it('updates the attributes that we select only without updating createdAt', function () {
            var User = /** @class */ (function (_super) {
                ...
                __decorate([
                    index_1.Column,
                    __metadata("design:type", String)
                ], User.prototype, "secretValue", void 0);
                User = __decorate([
                ...
                return User.create({ username: 'Peter', secretValue: '42' }).then(function (user) {
                    return user.updateAttributes({ secretValue: '43' }, {
                        fields: ['secretValue'], logging: function (sql) {
                            ...
                            chai_1.expect(sql).to.match(/UPDATE\s+[`"]+User[`"]+\s+SET\s+[`"]+secretValue[`"]='43',[`"]+updatedAt[`"]+='[^`",]+'\s+WHERE [`"]+id[`"]+\s=\s1/);
                        }
                    });
                });
            }).then(function () {
